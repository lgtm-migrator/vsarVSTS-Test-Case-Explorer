...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        exec: {
			...
			tsdinit:{
				command: "tsd install jquery q knockout jqueryui ",
                stdout: true,
                stderr: true
			},
			tsdlink:{
        ...
        copy: {
            main: {
                files: [
                  ...
                  { expand: true, flatten: true, src: ['node_modules/vss-web-extension-sdk/lib/VSS.SDK.js'], dest: 'scripts/lib/', filter: 'isFile' }
                ]
            }
        },
        jasmine: {
